      ...
      <main className="flex flex-1 items-center justify-center px-5 py-16 md:px-8">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === "signup" && (
              <label className="block">
                <span className="mb-1.5 block text-sm font-semibold text-[#303236]">{t("auth.name")}</span>
                <input
                  type="text"
                  required
                  value={username}
            ...
            <label className="block">
              <span className="mb-1.5 block text-sm font-semibold text-[#303236]">{t("auth.password")}</span>
              <input
                type="password"
                required
                minLength={6}
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs font-medium text-[#a3a9b3]">{t("auth.or")}</span>
            <div className="h-px flex-1 bg-[#e5e0d5]" />
          </div>
